...
public class VoucherReqController {
	...
	@PostMapping("/voucher")
    public ResponseEntity<VoucherRequest> requestVoucher(@Valid @RequestBody VoucherRequestDto request) throws ScoreNotValidException, ResourceNotFoundException {
